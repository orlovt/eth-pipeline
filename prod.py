...
def produce(producer, topic, transaction_data):
    try:
        ...
        while True:
            try:
                ...
                if 'params' in response_json:
                    ...
                    await analyze_block(block, config, topic)
                ...
                print(f"Error while receiving block data: {e}")

async def analyze_block(block, config, topic):
    ...
    with ThreadPoolExecutor() as executor:
        ...
        for tx in block.transactions:
            ...
            task = loop.run_in_executor(executor, produce, producer, topic, transaction_data)
            tasks.append(task)
